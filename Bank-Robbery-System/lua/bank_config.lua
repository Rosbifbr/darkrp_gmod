...
BANK_CONFIG.CooldownTime = 300 -- The amount of time that you need to wait before you can rob the bank again after a failed/sucessfull robbery.
...
BANK_CONFIG.Government = { -- The teams considered cops by the bank.
	["Police"] = true, -- uses the name displayed in the F4 menu. (Uses the name displayed in the F4 menu)
	["Sheriff"] = true,
}
