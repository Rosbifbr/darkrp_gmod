...
function zmlab2.Tent.OnThink(Tent)
    ...
    if zmlab2.util.InDistance(LocalPlayer():GetPos(), Tent:GetPos(), 1500) and i_state > -1 and i_state < 2 then
...
function zmlab2.Tent.Draw(Tent)
    if zmlab2.util.InDistance(Tent:GetPos(), LocalPlayer():GetPos(), 1500) and IsValid(Tent.PreviewModel) then
