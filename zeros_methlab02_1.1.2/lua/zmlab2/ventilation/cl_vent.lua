...
function zmlab2.Ventilation.OnThink(Ventilation)
    if zmlab2.util.InDistance(LocalPlayer():GetPos(),Ventilation:GetPos(), 1000) and IsValid(Ventilation:GetOutput()) then
...
function zmlab2.Ventilation.Draw(Ventilation)
    ...
    if zmlab2.util.InDistance(Ventilation:GetPos(), LocalPlayer():GetPos(), 2500) then
...
function zmlab2.Ventilation.DrawPipe(Ventilation)
    ...
    if zmlab2.util.InDistance(LocalPlayer():GetPos(), Ventilation:GetPos(), 2000) then
