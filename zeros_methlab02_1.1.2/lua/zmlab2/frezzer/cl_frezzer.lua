...
function zmlab2.Frezzer.Think(Frezzer)
    ...
    if zmlab2.util.InDistance(LocalPlayer():GetPos(),Frezzer:GetPos(), 1000) then
...
function zmlab2.Frezzer.Draw(Frezzer)
    ...
    if zmlab2.util.InDistance(LocalPlayer():GetPos(),Frezzer:GetPos(), 1000) and zmlab2.Convar.Get("zmlab2_cl_drawui") == 1 then
