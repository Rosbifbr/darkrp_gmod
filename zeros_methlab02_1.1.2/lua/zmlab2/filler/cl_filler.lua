...
function zmlab2.Filler.Think(Filler)
    if zmlab2.util.InDistance(LocalPlayer():GetPos(), Filler:GetPos(), 1000) and Filler:GetProcessState() == 2 and (Filler.NextEffect == nil or Filler.NextEffect < CurTime()) then
...
function zmlab2.Filler.Draw(Filler)
    ...
    if zmlab2.util.InDistance(LocalPlayer():GetPos(), Filler:GetPos(), 1000) and zmlab2.Convar.Get("zmlab2_cl_drawui") == 1 then
